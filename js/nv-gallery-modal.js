...
(function (global) {
  ...
  const MODAL_HTML = "<div class=\"product-modal\" id=\"productModal\" aria-hidden=\"true\"><div class=\"product-modal-box\"><button class=\"product-close\" id=\"productClose\" type=\"button\" aria-label=\"Close\">✕</button><div class=\"product-layout\"><div class=\"product-left\"><div class=\"product-gallery\"><button class=\"gallery-arrow left\" id=\"galleryPrev\" type=\"button\" aria-label=\"Previous photo\">‹</button><img id=\"productImg\" src=\"\" alt=\"Artwork\" decoding=\"async\" loading=\"lazy\"><button class=\"gallery-arrow right\" id=\"galleryNext\" type=\"button\" aria-label=\"Next photo\">›</button></div></div><div class=\"product-right\"><h2 id=\"productTitle\"></h2><p class=\"muted\" id=\"productDesc\"></p><ul class=\"product-info\"><li><b>Size:</b> <span id=\"productSize\"></span></li><li><b>Medium:</b> <span id=\"productMedium\"></span></li><li><b>Year:</b> <span id=\"productYear\"></span></li></ul><div class=\"product-buy\"><div class=\"product-buy__price-row\"><div class=\"product-price\" id=\"productPrice\"></div></div><button class=\"morePhotosBtn\" id=\"morePhotosBtn\" type=\"button\" aria-expanded=\"false\">More photos <span class=\"arrow\">↓</span></button><div class=\"product-thumbs-shell\" id=\"productThumbsShell\" aria-hidden=\"true\"><div class=\"product-thumbs-shell__inner\"><div class=\"product-thumbs\" id=\"productThumbs\"></div></div></div><div class=\"product-modal-gift-card\" id=\"frameSelectionCard\" role=\"group\" aria-labelledby=\"frameSelectionLabel\"><div class=\"product-modal-gift-card__main\"><div class=\"product-modal-gift-card__text\"><span class=\"product-modal-gift-card__title\" id=\"frameSelectionLabel\">ჩარჩო</span><span class=\"product-modal-gift-card__meta\">+ €15</span></div></div><label class=\"product-modal-gift-switch\"><input type=\"checkbox\" id=\"frameSelectionToggle\" class=\"product-modal-gift-switch__input\"><span class=\"product-modal-gift-switch__track\"><span class=\"product-modal-gift-switch__thumb\"></span></span></label></div><div class=\"product-modal-gift-card\" id=\"giftPackagingCard\" role=\"group\" aria-labelledby=\"giftPackagingLabel\"><div class=\"product-modal-gift-card__main\"><div class=\"product-modal-gift-card__text\"><span class=\"product-modal-gift-card__title\" id=\"giftPackagingLabel\">სასაჩუქრე შეფუთვა</span><span class=\"product-modal-gift-card__meta\">+ €5</span></div></div><label class=\"product-modal-gift-switch\"><input type=\"checkbox\" id=\"giftPackagingToggle\" class=\"product-modal-gift-switch__input\"><span class=\"product-modal-gift-switch__track\"><span class=\"product-modal-gift-switch__thumb\"></span></span></label></div><div class=\"product-modal-gift-card\" id=\"courierDeliveryCard\" role=\"group\" aria-labelledby=\"courierDeliveryLabel\"><div class=\"product-modal-gift-card__main\"><div class=\"product-modal-gift-card__text\"><span class=\"product-modal-gift-card__title\" id=\"courierDeliveryLabel\">საკურიერო მომსახურება</span><span class=\"product-modal-gift-card__meta\">+ €10</span></div></div><label class=\"product-modal-gift-switch\"><input type=\"checkbox\" id=\"courierDeliveryToggle\" class=\"product-modal-gift-switch__input\"><span class=\"product-modal-gift-switch__track\"><span class=\"product-modal-gift-switch__thumb\"></span></span></label></div><button type=\"button\" id=\"addToCartBtn\" class=\"product-modal-add-cart\" aria-label=\"Add to cart — inquire via WhatsApp\">Add to Cart</button></div></div></div></div></div></div>";
